...
const loadRanking = () => {
    ...
    const turmaUser = localStorage.getItem('userClass');
    ...
    pontoUser.innerHTML = `<h2> Parabéns, você conseguiu ${userScore}/15 pontos!</h2>`; // cria um h2 com o numero atual do Score do user 
